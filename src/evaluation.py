...
def create_all_plots_together( path="figures/together", clusterfile = "data/clusters.txt" ):
    ...
    print( "iid" )
    save_figure( plot_iid( [tracks1c, tracks2c, tracks3c, tracks4c, tracks5c, tracks6c, tracks7c, tracks8c], multipletracksets=True ), path=(path + "iid.png" ), size=(24,18) )
    print( "tankpositions" )
    save_figure( plot_tankpositions( [tracks1c, tracks2c, tracks3c, tracks4c, tracks5c, tracks6c, tracks7c, tracks8c], multipletracksets=True ), path=(path + "tankpositions.png" ) )
