...
def main():
    ...
    # get locomotion
    df = pd.read_csv("4model_v9_128_64_9_10_70_tracks.csv", index_col=0, sep = ";")
    tracks = df.to_numpy()
    print( tracks.shape )
    ...
    # create_plots( tracks[:,[0,1,2,3,8,9,10,11,16,17,18,19]], path="figures/simulation_4model_v9_128_64_9_10_70" )
    visualization.addVideoOnTank( "C:/Users/Gabriel/Videos/sim_tracks_4model_v9_128_64_9_10_70.avi", tracks, skeleton=[(0,1),(1,2),(2,3)], psize=2, showvid=False ) #"I:/Code/SWP/sim_tracks.avi"
